...
class CoinInfoAdapter : ListAdapter<CoinInfo, CoinInfoViewHolder>(CoinInfoDiffUtil()) {
    ...
    override fun onBindViewHolder(holder : CoinInfoViewHolder, position : Int) {
        ...
        binding.tvLastUpdate.text = String.format(lastUpdateTemplate, coin.lastUpdate.toConvertTimestampToTime())
        Picasso.get().load(coin.imageUrl.toGetFullImageUrl()).into(binding.ivLogoCoin)
    }
